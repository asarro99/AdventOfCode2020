...
public class IterTools {
  ...
  /**
   * Returns a List of combinations of the input collection, where each combination is of length r
   * and sorted by lexicographic order.
   *
   ...
   * @return A List of combinations of the input collection, where each combination is of length r
   *     and sorted by lexicographic order.
   * @see <a href=https://docs.python.org/2/library/itertools.html#itertools.combinations>Python
